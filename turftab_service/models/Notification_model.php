...
class Notification_model extends CI_Model {
	...
	public function user_notifications_history($user_id)
	{
		...
		$this->db->join('ct_events e','n.notifications_event_id=e.events_id AND (n.notifications_type="event_create" OR n.notifications_type="event_update" OR n.notifications_type="event_interested" OR n.notifications_type="event_comment" OR n.notifications_type="event_invite" OR n.notifications_type="event_review" OR n.notifications_type="event_reply")','left');
