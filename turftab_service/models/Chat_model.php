...
class Chat_model extends CI_Model {
	...
	/* =============       To check whether the user is super admin or sub admin       ============== */
    public function check_admin_user_add($user_id,$group_id) {

		$where_cond = "(chat_group_id='".$group_id."' AND group_member_id='".$user_id."' AND (user_role=1 OR user_role=2) AND group_members_status=1)";

        $model_data = $this->db->get_where('ct_group_members',$where_cond)->num_rows();
